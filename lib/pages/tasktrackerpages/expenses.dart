...
class _ExpensesState extends ConsumerState<Expenses> {
  ...
  Widget _buildTotalTile(
    ...
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(10),
        color: Color.fromARGB(255, 123, 228, 252),
      ),
      child: ListTile(
        title: Text(
          attributeName,
  ...
  Widget _buildRemainingTile(BuildContext context, String attributeName,
    ...
    return remainingStream.when(
      data: (remaining) {
        final tileColor = remaining > 0 ? Colors.green : Colors.red;
        return Container(
          decoration: BoxDecoration(
            color: tileColor,
            borderRadius: BorderRadius.circular(10),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ref
                    ...
                    .updateTaskIntValue(user.uid, attributeName, newValue);
              },
              child: const Text(
                'OK',
                style: TextStyle(
